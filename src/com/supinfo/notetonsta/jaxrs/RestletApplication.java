...
import com.supinfo.notetonsta.jaxrs.resources.RegistrationResource;
import com.supinfo.notetonsta.jaxrs.resources.ServiceResource;
import com.supinfo.notetonsta.jaxrs.resources.SpeakerResource;
...
public class RestletApplication extends Application {
	...
	public Set<Class<?>> getClasses() {
        ...
        rrcs.add(RegistrationResource.class);
        rrcs.add(InterventionResource.class);
        rrcs.add(CampusResource.class);
        rrcs.add(SpeakerResource.class);
