...
<script type="text/javascript" src="${ pageContext.request.contextPath }/assets/js/intervention_form_validation.js"></script>
...
<body>
	...
	<form id="new_intervention" class="clearfix" action="${ pageContext.request.contextPath }/interventions/create" method="post">		
		<input type="hidden" name="intervention_id" value="${ requestScope.intervention.key.id }" /> 
		<div class="clearfix">
		...
		<div class="actions">
            <input type="submit" class="btn primary" value="Create intervention">&nbsp;<a href="${ pageContext.request.contextPath }/interventions/mine" class="btn">Cancel</a>
        </div>
	</form>
</body>
</html>